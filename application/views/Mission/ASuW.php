                    ...
                    <div class="card-body bg-custom3">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-4 mb-1">
                                         <select class="form-control rounded-pill" name="mission1" id="mission1" data-placeholder="Select mission" style="font-size: 0.8rem; height:50px;">\
